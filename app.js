...
let app = new Vue({
  ...
  data: {
    ...
    sortOption: 'asc',
    classList: list = [
                  { id: 1, title: 'Maths Tutoring - Year 10', description: 'Maths support for Year 10 students.', price: 30, spaces: 5, ratings: 5, subject: 'Maths', image: 'images/math-image.jpg' },
                  ...
                  { id: 4, title: 'Music Lessons - Guitar', description: 'Learn to play the guitar from experienced instructors.', spaces: 5, price: 40, ratings: 4, subject: 'Music', image: 'images/music-image.jpg' },
                  { id: 5, title: 'Painting for Young Artists', description: 'A creative painting class for aspiring artists.', price: 22, spaces: 5, ratings: 4, subject: 'Arts', image: 'images/arts-image.jpg' },
                  { id: 6, title: 'Robotics and Coding - Level 1', description: 'Learn the basics of robotics and classListming.', price: 50, spaces: 5, ratings: 5, subject: 'Technology', image: 'images/technology-image.jpg' },
                  ...
                  { id: 8, title: 'Drama and Acting Workshop', description: 'An interactive workshop focused on acting skills.', price: 30, spaces: 5, ratings: 3, subject: 'Drama', image: 'images/drama-image.jpg' },
                  { id: 9, title: 'Physical Education and Fitness', description: 'A fun fitness class for kids to stay active.', price: 18, spaces: 5, ratings: 4, subject: 'Physical Education', image: 'images/physical_education-image.jpg' },
